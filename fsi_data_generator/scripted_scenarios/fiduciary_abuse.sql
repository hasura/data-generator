...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'John Doe' AND email_address = 'john.doe@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Jane Smith' AND email_address = 'jane.smith@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
INSERT INTO consumer_banking.accounts (enterprise_account_id, consumer_banking_product_id, opened_date, status, status_update_date_time)
SELECT
    (SELECT enterprise_account_id FROM enterprise.accounts WHERE description = 'John Doe Main Account' ORDER BY enterprise_account_id DESC LIMIT 1),
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Alice Johnson' AND email_address = 'alice.johnson@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Bob Williams' AND email_address = 'bob.williams@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Charlie Brown' AND email_address = 'charlie.brown@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Lucy Van Pelt' AND email_address = 'lucy.vanpelt@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
...
SELECT
    ...
    (SELECT enterprise_party_id FROM enterprise.parties WHERE name = 'Linus Van Pelt' AND email_address = 'linus.vanpelt@example.com' ORDER BY enterprise_party_id DESC LIMIT 1);
