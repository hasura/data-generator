    ...
    try:
        ...
        if result:
            return {
                ...
                "loan_term_months": result[2],
                "monthly_payment": float(result[3]) if result[3] is not None else None,
                "down_payment": float(result[4]) if result[4] is not None else None,
                "origination_date": result[5]
            }
        else:
            return None
