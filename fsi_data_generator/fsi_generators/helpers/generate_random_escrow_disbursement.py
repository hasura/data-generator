...
def generate_random_escrow_disbursement(id_fields: Dict[str, Any], dg) -> Dict[str, Any]:
    ...
    if disbursement_type == "property tax":
        ...
        try:
            ...
            insurance_companies.extend(carrier_names)
        except:
            pass
        ...
        try:
            alt_mi_companies = generate_unique_json_array(
                dbml_string=dg.dbml,
            ...
            mi_companies.extend(alt_mi_companies)
        except:
            pass
