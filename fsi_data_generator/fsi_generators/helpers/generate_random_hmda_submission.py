    ...
    if submission_status in ["accepted", "rejected"]:
        ...
        if submission_status == "accepted":
            ...
            try:
                ...
                print(f"Warning: Couldn't generate HMDA acceptance details: {e}")
            ...
            try:
                ...
                print(f"Warning: Couldn't generate HMDA rejection details: {e}")
                # Continue with just the hardcoded messages
...
def get_report_info(report_id: int, conn) -> Dict[str, Any]:
    ...
    try:
        ...
        print(f"Error fetching report information: {error}")
        return {}
...
def generate_associate_id(dg: DataGenerator):
    ...
    try:
        ...
        print(f"Warning: Couldn't fetch associate ID: {e}")
