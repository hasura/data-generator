...
if __name__ == "__main__":
    ...
    # Generate an application using the product constraints
    application = generate_random_application(sample_product)

    # Print application details
    print("Application Details:")
    print(f"Type: {application['application_type']}")
    print(f"Status: {application['status']}")
    print(f"Purpose: {application['loan_purpose']}")
    print(f"Amount: ${application['requested_loan_amount']:,.2f}")
    print(f"Term: {application['requested_loan_term_months']} months")
    print(f"Credit Score: {application['estimated_credit_score']}")
    print(f"Property Value: ${application['estimated_property_value']:,.2f}")
    print(f"Created: {application['creation_date_time']}")
    print(f"Submitted: {application['submission_date_time']}")
    print(f"Last Updated: {application['last_updated_date_time']}")
    print(f"Referral Source: {application['referral_source']}")

    # Generate an application without providing a product
    default_application = generate_random_application()
    print("\nDefault Application Amount:", f"${default_application['requested_loan_amount']:,.2f}")
