...
if __name__ == "__main__":
    # This would be replaced with actual connection parameters
    ...
    try:
        ids = {
            ...
            'mortgage_services_borrower_id': 67890
        }
        record = generate_application_borrower_record(ids, cast(DataGenerator, {conn: conn}))
        print(record)
