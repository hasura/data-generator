...
from fsi_data_generator.fsi_text.consumer_lending.consumer_lending__disbursements__notes import \
...
def consumer_lending(dg):
    return [
        ...
        (
            'consumer_lending\\.payment_arrangements', '^notes$',
            text_list(consumer_lending__payment_arrangements__notes)),
        ...
        ('consumer_lending\\.loan_communications', '^direction$', text_list(
            consumer_lending__loan_communications__direction)),
        (
            'consumer_lending\\.loan_communications', '^status$',
            text_list(consumer_lending__loan_communications__status)),
        ('consumer_lending\\.loan_statements', '^delivery_method$', text_list(
            consumer_lending__loan_statements__delivery_method)),
        (
            'consumer_lending\\.collection_accounts', '^status$',
            text_list(consumer_lending__collection_accounts__status)),
        ...
        ('consumer_lending\\.disbursements', '^disbursement_status$', text_list(
            consumer_lending__disbursements__disbursement_status)),
        (
            'consumer_lending\\.loan_payments', '^payment_type$',
            text_list(consumer_lending__loan_payments__payment_type)),
        ...
        ('consumer_lending\\.credit_inquiries', '^inquiry_type$', text_list(
            consumer_lending__credit_inquiries__inquiry_type)),
        (
            'consumer_lending\\.public_records', '^record_type$',
            text_list(consumer_lending__public_records__record_type)),
        ...
        ('consumer_lending\\.credit_report_tradelines', '^worst_delinquency$', text_list(
            consumer_lending__credit_report_tradelines__worst_delinquency)),
        (
            'consumer_lending\\.credit_reports', '^report_type$',
            text_list(consumer_lending__credit_reports__report_type)),
        (
            'consumer_lending\\.credit_reports', '^bureau_name$',
            text_list(consumer_lending__credit_reports__bureau_name)),
