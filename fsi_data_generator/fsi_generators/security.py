...
def security(dg):
    return [
        ...
        ('security\\.identity_roles', '^security_identity_id$', get_entity_combiner(dg, 'security.identities.security_identity_id', 'security.roles.security_role_id')),
        ('security\\.identity_roles', '^security_role_id$', lambda a, b, c: a['security_role_id']),
        ('security\\.identity_entitlements', '^security_identity_id$', get_entity_combiner(dg, 'security.identities.security_identity_id', 'security.entitlements.security_entitlement_id')),
        ('security\\.identity_entitlements', '^security_entitlement_id$', lambda a, b, c: a['security_entitlement_id']),
        ('security\\.identity_access_profiles', '^security_identity_id$', get_entity_combiner(dg, 'security.identities.security_identity_id', 'security.access_profiles.security_access_profile_id')),
        ('security\\.identity_access_profiles', '^security_access_profile_id$',
         lambda a, b, c: a['security_access_profile_id']),
