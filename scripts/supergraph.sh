...
ddn connector init consumer_banking --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init consumer_lending --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init mortgage_services --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init credit_cards --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init small_business_banking --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init enterprise --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init security --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
...
ddn connector init app_mgmt --hub-connector hasura/postgres --add-env CONNECTION_URI="postgres://postgres:password@local.hasura.dev:5432" --add-to-compose-file ./compose.yaml
